...
#include "WatchData.h"
#include "WatchFunc.h"
#include "Module_Brightness.h"
#include "Module_Hour.h"
#include "Module_Minute.h"
#include "Module_ClockMode.h"
#include "Module_WristMode.h"
...
void loop() {
  ...
  if (wake_flag) {
    ...
    // while (millis() - batteryMillis < charge_timer) {
    //   Mod_Battery(500, true);
    //   Mod_Charge();
    // }
